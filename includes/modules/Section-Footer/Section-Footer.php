...
class CA_Section_Footer_Legacy extends ET_Builder_Module {
    ...
    function init() {
        $this->name = esc_html__('Section - Footer (Legacy)', 'et_builder');
...
new CA_Section_Footer_Legacy;

class CA_Section_Footer_Group_Legacy extends ET_Builder_Module {
    function init() {
        $this->name = esc_html__('Footer Group (Legacy)', 'et_builder');
...
new CA_Section_Footer_Group_Legacy;

// Fullwidth Version
class CA_Fullwidth_Section_Footer_Legacy extends ET_Builder_Module {
    function init() {
        $this->name = esc_html__('Section - Footer (Legacy)', 'et_builder');
...
new CA_Fullwidth_Section_Footer_Legacy;

class CA_Fullwidth_Section_Footer_Group_Legacy extends ET_Builder_Module {
    function init() {
        $this->name = esc_html__('Footer Group (Legacy)', 'et_builder');
