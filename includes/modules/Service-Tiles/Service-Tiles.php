...
class CA_Service_Tiles extends ET_Builder_Module {
    ...
    function init() {
        $this->name = esc_html__('FullWidth Service Tiles (Legacy)', 'et_builder');
...
new CA_Service_Tiles;

class CA_Service_Tiles_Item extends ET_Builder_Module {
    function init() {
