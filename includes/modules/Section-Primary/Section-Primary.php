...
class CA_Section_Primary extends ET_Builder_Module {
    ...
    function init() {
        $this->name = esc_html__('Section - Primary (Legacy)', 'et_builder');
...
new CA_Section_Primary;


// Fullwidth Version
class CA_Section_Primary_FullWidth extends ET_Builder_Module {
    function init() {
        $this->name = esc_html__('Section - Primary (Legacy)', 'et_builder');
...
new CA_Section_Primary_FullWidth;